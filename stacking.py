...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 11 15:09:07 2018
...
class ModelStacking:
    def __init__(self, train_data, test_data, online_data, predictors, models=['et', 'rf', 'xgb', 'cb', 'lgb'], dep='y',
                 nfolds=5, seed=0):
        """
    ...
    def model_train_predict(self):
        ...
        for mm in self.models:
            if mm == 'et':
                self.build_models['et'] = SklearnWrapper(clf=ExtraTreesClassifier, seed=self.seed,
                                                         params=self.params_dic['et_params'])
                ...
                self.build_models['rf'] = SklearnWrapper(clf=RandomForestClassifier, seed=self.seed,
                                                         params=self.params_dic['rf_params'])
                ...
                self.build_models['cb'] = CatboostWrapper(clf=CatBoostClassifier, seed=self.seed,
                                                          params=self.params_dic['cb_params'])
...
if __name__ == '__main__':
    ...
    ms = ModelStacking(train_data[feature_columns+['label']][:50000], train_data[feature_columns+['label']][:50000], test, feature_columns, models=['et', 'rf', 'xgb', 'lgb'],
                       dep='label')
    c = ms.stacking()